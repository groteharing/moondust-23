window.onload = function () {
  ...
  mm.add("(max-width: 767px)", () => {
    ...
    // Intro SVG logo
    introMobile.to("#intro-svg", { ease: "power4.in", duration: 1.2, autoAlpha: 100 });
    introMobile.to(
      "#intro-svg",
  ...
  mm.add("(min-width: 768px)", () => {
    ...
    // Intro SVG logo
    introDesktop.to("#intro-svg", { ease: "power4.in", duration: 1.2, autoAlpha: 100 });
    introDesktop.to(
      "#intro-svg",
      { y: -80, ease: "power4.easeout", duration: 0.6, display: "none" },
      1
